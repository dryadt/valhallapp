    ...
    public class Commands : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task HelpMeme()
        {
            ...
            embed.WithTitle("Meme commands list:")
                ...
                .AddField($"{prefix}Oh! You go big guy!", "Do i need to say anything about the GOTY?")
                .AddField($"{prefix}Pose for the fans!", "Do i need to say anything about the GOTY?")
                .AddField($"{prefix}starless", "Mega Bi stag.")
                .AddField($"{prefix}Wubbadubadub is that true?", "Do i need to say anything about the GOTY?")
                .WithFooter(footer => footer.Text = "Page 1 out of 1.")
                .WithColor(Color.Blue)
                .WithCurrentTimestamp()
                .Build();
